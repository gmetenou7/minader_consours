<div class="wrapper">
    <?php if(!empty($candidat)){ ?>
        ...
        <div class="kt-section__content kt-section__content--border">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link active" href="<?=base_url('print/'.$this->uri->segment(2));?>" download>Télécharger ma fiche</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('cfiche/'.$this->uri->segment(2));?>">Voir ma fiche</a>
                </li>
            </ul>
        </div>
        
        <h3 class="pull-center">MODIFICATION</h3>
	...
	<span class="text-info" id="success"></span>
    <?php }else{ ?>
        <h4 class="text-danger">OUPS ERREUR SURVENUE</h4>
    <?php } ?>
</div>
