...
class Pagination{
    ...
    */
    public function config($url, $get,$per_page){
        ...
        $config['per_page'] = $per_page; /*$this->offset;*/
    ...
    */
    public function result($per_page){
        return $this->_return($this->get->result(),$per_page);
    }
    ...
    */
    public function result_array($per_page){
        return $this->_return($this->get->result_array(),$per_page);
    }
    ...
    */
    private function _return($data,$per_page){
        $i=0;
